...
// CustomerEndpoints - API-lagret för kunder

// Extension method som utökar WebApplication med kundrelaterade
// endpoints. Detta är en del av Minimal API-mönstret där vi
// separerar endpoints i egna klasser för bättre struktur.
//
// Flöde för varje anrop:
// HTTP-anrop → Endpoint → CustomerService (affärslogik) 
// → CustomerRepository (databasåtkomst) → Cosmos DB
